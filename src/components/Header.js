...
import { majorScale, Heading, Link, Pane, SearchInput } from "evergreen-ui";
...
function Header() {
  ...
  return (
    <Pane background="white" elevation={1}>
      <Pane className="row-wrap" display="flex" borderBottom="default">
        <Pane className="align title" display="flex" flex="1 1 60%">
          <Link
            href="#/"
            textDecoration="none"
            display="flex"
